...
> ⚠️ **Demo note:** The live instance runs on Render's free tier with SQLite. Data may reset on cold starts. Use test credentials — don't store anything real.
...
└── frontend/
    ...
    │   └── lib/                  # API client
    └── public/                   # face-api.js model weights (loaded client-side)
```
...
- **Single-service SQLite** — not designed for concurrent multi-user production load
